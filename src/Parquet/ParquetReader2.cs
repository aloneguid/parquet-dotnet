...
namespace Parquet
{
   ...
   /// </summary>
   internal class ParquetReader2 : ParquetActor, IDisposable
   {
      ...
      public ParquetReader2(Stream input, ParquetOptions formatOptions = null, ReaderOptions readerOptions = null) : base(input)
      {
      ...
      public static DataSet ReadFile(string fullPath, ParquetOptions formatOptions = null, ReaderOptions readerOptions = null)
      {
         ...
         {
            using (var reader = new ParquetReader2(fs, formatOptions, readerOptions))
            {
               return reader.Read();
            }
         }
      ...
      {
         using (var reader = new ParquetReader2(source, formatOptions, readerOptions))
         {
            return reader.Read();
         }
      }
