...
namespace Parquet.Serialization {
    ...
    public class SchemaReflector {
        ...
        private static readonly ConcurrentDictionary<Type, ParquetSchema> _cachedReflectedSchemas = new ConcurrentDictionary<Type, ParquetSchema>();
        ...
        private Field GetField(PropertyInfo property) {
            ...
            if(pt.TryExtractEnumerableType(out Type t))
                pt = t;
        ...
        readonly Func<PropertyInfo, bool> pickSerializableProperties = (PropertyInfo arg) => !arg.CustomAttributes.Any(p => p.AttributeType == typeof(ParquetIgnoreAttribute));
