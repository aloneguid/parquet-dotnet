...
{
   /// <summary>
   /// Implements Apache Parquet format writer (legacy)
   /// </summary>
   internal class ParquetWriter2 : ParquetActor, IDisposable
   {
      ...
      public ParquetWriter2(Stream output, ParquetOptions formatOptions = null, WriterOptions writerOptions = null) 
      ...
      {
         using (var writer = new ParquetWriter2(destination, formatOptions, writerOptions))
         {
      ...
      public static void WriteFile(DataSet dataSet, string fileName, CompressionMethod compression = CompressionMethod.Gzip, ParquetOptions formatOptions = null, WriterOptions writerOptions = null, bool append = false)
      {
         ...
         {
            using (var writer = new ParquetWriter2(fs, formatOptions, writerOptions))
            {
