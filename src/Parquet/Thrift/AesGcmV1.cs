...
namespace Parquet.Thrift
{
  ...
  public partial class AesGcmV1 : TBase
  {
    ...
    {
      var tmp260 = new AesGcmV1();
      if((Aad_prefix != null) && __isset.aad_prefix)
      {
        tmp260.Aad_prefix = this.Aad_prefix.ToArray();
      }
      tmp260.__isset.aad_prefix = this.__isset.aad_prefix;
      if((Aad_file_unique != null) && __isset.aad_file_unique)
      {
        tmp260.Aad_file_unique = this.Aad_file_unique.ToArray();
      }
      tmp260.__isset.aad_file_unique = this.__isset.aad_file_unique;
      if(__isset.supply_aad_prefix)
      {
        tmp260.Supply_aad_prefix = this.Supply_aad_prefix;
      }
      tmp260.__isset.supply_aad_prefix = this.__isset.supply_aad_prefix;
      return tmp260;
    }
    ...
    {
      var tmp263 = new StringBuilder("AesGcmV1(");
      int tmp264 = 0;
      if((Aad_prefix != null) && __isset.aad_prefix)
      {
        if(0 < tmp264++) { tmp263.Append(", "); }
        tmp263.Append("Aad_prefix: ");
        Aad_prefix.ToString(tmp263);
      }
      if((Aad_file_unique != null) && __isset.aad_file_unique)
      {
        if(0 < tmp264++) { tmp263.Append(", "); }
        tmp263.Append("Aad_file_unique: ");
        Aad_file_unique.ToString(tmp263);
      }
      if(__isset.supply_aad_prefix)
      {
        if(0 < tmp264++) { tmp263.Append(", "); }
        tmp263.Append("Supply_aad_prefix: ");
        Supply_aad_prefix.ToString(tmp263);
      }
      tmp263.Append(')');
