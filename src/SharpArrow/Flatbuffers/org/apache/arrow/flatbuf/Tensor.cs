...
public struct Tensor : IFlatbufferObject
{
  ...
  public FBType TypeType { get { int o = __p.__offset(4); return o != 0 ? (FBType)__p.bb.Get(o + __p.bb_pos) : FBType.NONE; } }
  ...
  public static void AddTypeType(FlatBufferBuilder builder, FBType typeType) { builder.AddByte(0, (byte)typeType, 0); }
